                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="/addcatqry" class="form-group" enctype="multipart/form-data" style="width: 45%;">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                <label>Category</label>
                                <input type="text" name="cat" class="form-control" required=""><br>
                                <label>Image</label>
                                <input type="file" name="cimage" class="form-control" required=""><br>
                                ...
                                <input type="hidden" name="lnid" id="lnid" class="form-control">
