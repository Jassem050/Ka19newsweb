                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <form method="post" action="/addadvqry" class="form-group" enctype="multipart/form-data" style="width: 50%;">
                                ...
                                <input type="date" name="duration" min="{{ date('Y-m-d') }}" class="form-control" required=""><br> 
