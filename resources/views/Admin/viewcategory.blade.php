        ...
        <div class="dash-app">
            ...
            <main class="dash-content">
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-head">Category</div>
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img src="{{ asset('admin/category/'.$value->category_image) }}" width="100" height="100"></td>
                                        <td>{{ $value->language_name }}</td>
                                        <td>
                                            <a href="/updatecat/{{ $value->category_id }}" class="btn btn-info">Edit</a>
                                            @if($value->category_status == 0)
                                            <a onclick="return confirm('Are you sure to enable?')" href="/togglecat/{{ $value->category_id }}/enable" class="btn btn-success">Enable</a>
                                            @else
                                            <a onclick="return confirm('Are you sure to disable?')" href="/togglecat/{{ $value->category_id }}/disable" class="btn btn-danger">Disable</a>
                                            @endif
                                        </td>
                                    </tr>
                                    @endforeach
