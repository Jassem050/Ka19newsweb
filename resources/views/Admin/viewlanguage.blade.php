                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-primary edit-modal" data-id="{{$value->language_id}}" data-name="{{$value->language_name}}">Edit</button>
                                            <a href="/dellang/{{ $value->language_id }}" class="btn btn-danger">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form method="post" action="/updatelang" class="form-group">
                  @csrf
                    <input type="hidden" class="form-control" name="lgid" id="id" readonly>
                    <label for="cat">Language</label>
                    <input type="text" class="form-control" name="language" id="n" required><br>
