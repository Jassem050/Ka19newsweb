                ...
                <div class="container-fluid">
                    <div class="card">
                        ...
                        @if(Session::has('success')) 
                            ...
                            @endif
                            <form method="post" action="/updatenews" class="form-group" enctype="multipart/form-data" style="width: 45%;">
                                ...
                                <input type="text" name="ntitle" class="form-control" value="{{ $value->news_title }}" required=""><br> 
                                <label>News Content</label>
                                <textarea name="content" class="form-control" id="summernote" required="" style="resize: none;">{{ $value->news_content }}</textarea><br>  
                                <label>Place</label>
                                <input type="text" name="place" class="form-control" value="{{ $value->news_place }}" required=""><br> 
                                @endforeach
                                <input type="submit" name="add" class="btn btn-info" value="Update News">
                            </form>
                        </div>
                    </div>
                </div>
