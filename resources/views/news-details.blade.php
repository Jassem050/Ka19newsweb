                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="mobile-menu">
                            <nav id="dropdown">
                                 <a href="#"><img src="{{ asset('assets/logo/ka19@1x.png') }}" alt="" class="mobile-logo"></a>
                ...
                @foreach($news as $new)
                    <div class="col-lg-8 col-md-12">
                        <div class="news-heading">
                            ...
                            <ul class="list-unstyled list-inline">
                                <li class="list-inline-item"><i class="fa fa-user"></i><a href="#">{{ $new->admin_id }}</a></li>
                                <li class="list-inline-item"><i class="fa fa-calendar"></i>{{ $new->news_date }}</li>
                                <li class="list-inline-item"><i class="fa fa-hourglass"></i>{{$new->created_at->diffForHumans()}}</li>
                            </ul>
                           <!--  <figure> -->
                                <img src="{{ asset('admin/news/'.$new->news_image) }}" alt="" class="img-fluid">
                                <figcaption style="color: #D3D3D3;font-size: 12px;">{{ $new->news_image_caption }}</figcaption>
                            <!-- </figure> -->
...
<!-- Mirrored from snazzytheme.com/premium-themes/tennews-v1.0.1/news-details-one.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2019 11:14:03 GMT -->
</html>